...
//Q11;
let friends=["Hamail","Hassnain","Shafi"]
console.log(friends[0])
console.log(friends[1])
console.log(friends[2])
//Q12;
let relatives=["Mamo","Chachu"]
let mesg="hello,"
console.log(mesg+" "+relatives[0])
let mesg2="hi,"
console.log(mesg2+" "+relatives[1])
//Q13;
let guests=["fahad,","Asad,","Tuaha", "Hassnain",]
...
console.log(guests[3],"you are cordialy invited for dinner today night.");

//Q14;
//#print the invitation again...
console.log("print invite again!")
let g1=guests[1]
console.log("sorry,Asad can't make it to dinner.")
let g3=["Hassnain"]
console.log("Hassnain,come for dinner tonight")
//Q15;
//#lets add some more people...
console.log("we got a bigger table!")
let moreguests=["Samad,","Talha,"]
...
//Q17;
let places=["Mansehra","islamabad","murree","quetta"]
...
console.log(places)
//Q18;
let invitations=["Hamail","Shafi","hassnain"]
...
//Q29;
let fvtfruits=["apple","mango","banana"]
...
//Q30;
let usernames=["Hamail","Shafi","admin"]
if("admin"==usernames[2]){
    console.log("hello,admin;would you like to join us?")
}
if ("Hamail"==usernames[0]){
    console.log("hello,Hamail;thank you for logging in!")
}
if("ali"==usernames[1]){
    console.log("hello,Shafi;thank you for logging in!")
}
else{
...
//Q31;
let newMembers: any=[]
if ("admin"==newMembers[1]){
    console.log("hello,admin;would you like to join us?")
}
else if("Hassnain"==newMembers[1]){
    console.log("hello,Hassnain;you like to join")
}
else{
console.log("we need to find some new users!")
}
//Q32;
let currentuser=["admin","Hassnain"]
let newuser=["Hamail","Shafi"]
if("admin"==currentuser[0]){
    console.log("sorry,admin;you are not eligible for this!")
}
if("Hamail"==newuser[0]){
    console.log("congrats,Hamail;you are our new user!")
}
if("ali"==newuser[1]){
...
function greatmagicians(){
    ...
    console.log(magician1);
    console.log(magician2);
    console.log(magician1 + " the great magician");
    console.log(magician2 + " the great magician");
}
greatmagicians()
//Q43;
